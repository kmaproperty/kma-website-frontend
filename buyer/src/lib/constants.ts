...
export const channelPartnerMenuList = [
  {
    label: "Find an agent",
  },
  {
...
export const projectStatus = [
  ...
  {
    name: 'Partially Ready to Move',
    value: 'partially_ready_to_move'
  },
]
...
export const PRICE_OPTIONS_THOUSAND_LAKH = [
