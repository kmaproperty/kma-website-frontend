      ...
      {/* <div className="relative overflow-hidden rounded-b-[20px] sm:rounded-br-[30px] non_home_page_slider min-h-[330px] sm:min-h-[380px] md:min-h-[430px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center top-0 w-[100%] ">
          <div className="2xl:py-[150px] 1xl:py-[145px] xl:py-[130px] lg:py-[115px] 2md:py-[95px] md:py-[75px] sm:py-[75px] py-[75px]">
            <PageTitle
              title="About Us — KMA Global Properties | Gurgaon Real Estate Consultancy"
              description="Discover who we are, what we stand for, and why thousands of brokers and buyers across Gurgaon trust KMA Global Properties every single day."
              breadcrumps={breadcrumps}
              actions={[]}
            />
        ...
        <div className="flex xl:flex-row flex-col-reverse items-center justify-between max-w-[1440px] mx-auto gap-6">
          <div className="xl:w-[50%] w-full">
            {/* <SectionHeading
              ...
              color=""
              lineTop={false}
              description="KMA Global Properties is a real estate advisory and listings platform headquartered in Gurgaon, serving clients across the city's residential corridors, from Dwarka Expressway to Sohna Road and beyond. 
              Founded in 2025, the company brings together a growing network of over 3,500 channel partners and a client base that spans first-time homebuyers, seasoned investors, and NRIs exploring property investment solutions in India's NCR market.
              Our mission is practical: make property transactions easier, cleaner, and more transparent for every person involved, whether they're buying a 2 BHK in Sector 49, listing a luxury flat for rent, or building a brokerage practice in Gurgaon.
              We don't operate on vague promises. We operate on verified data, real support, and accountability at every step."
            /> */}

            <div
      className="flex flex-col gap-1.5"
    >
        <h2 className={`text-[28px] leading-11 font-semibold text-[#010048]`}>About KMA Global Properties</h2>

        <p
          className=""
        >
          KMA Global Properties is a real estate advisory and listings platform headquartered in Gurgaon, serving clients across the city's residential corridors, from Dwarka Expressway to Sohna Road and beyond.
        </p>
        <p
          className=""
        >
        ...
        >
          We don't operate on vague promises. We operate on verified data, real support, and accountability at every step.
            ...
            <div className="mt-8">
              <h2 className={`text-[28px] leading-11 font-semibold text-[#010048]`}>Founder’s Vision - Karmjeet Dahiya</h2>
              <div className="mt-5 grid grid-cols-1">
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <p>Karmjeet Dahiya didn't start KMA Global Properties to build another real estate portal. He started it because he saw a problem worth solving.</p>
                  <p>Having spent years observing how the property market operates in Gurgaon, the opacity, the broker exploitation, the gap between what clients were promised and what they actually received, he decided the industry needed a different kind of platform. One where transparency wasn't a marketing line, but an operating principle.</p>
                  <p>Karmjeet's approach to business is straightforward: treat brokers like partners, not inventory. Treat clients like people making one of the biggest financial decisions of their lives, not just a transaction. That belief is what shaped every decision behind KMA, from the free listing model to the live CRM system to the dedicated pre-sales support.</p>
                  <p>He built KMA in 2025 with a clear vision: a platform where the right people get the right property information at the right time, without the usual games. That vision continues to drive the company today.</p>
                </div>
                {/* <div className="w-full px-3 py-2 border border-gray-200 flex items-center gap-2 rounded-lg sm:w-fit sm:px-5 sm:gap-4">
                  <Image
                    src="/assets/team/founder1.png"
