...
//         }
//       })
//       .catch((err) => console.warn("RSS News flash delay:", err.message))
//       .finally(() => setLoading(false));
//   }, []);
...
//                 <div className="h-3 bg-slate-800/80 rounded w-28" />
//               </div>
//               <div className="h-6 bg-slate-800/80 rounded-lg w-28" />
//             </div>
//             <div className="h-6 bg-slate-800/80 rounded w-4/5 mt-2" />
//           </div>
//         ) : (
//           <div className="flex flex-col justify-between h-full">
...
//                 <h2 className="text-sm sm:text-base md:text-lg font-medium text-white tracking-wide leading-tight line-clamp-2 pr-2">
//                   {newsList[currentIndex]?.title}
//                 </h2>
//               </div>
//             </div>
...
export default function NewsFlashBanner() {
  ...
  return (
    <div className="w-[95%] lg:w-[57%] mx-auto px-4 my-3 md:my-10 pointer-events-none">
      <div className="relative w-full h-[120px] md:h-[125px] bg-[#02013b] text-white rounded-[12px] p-5 md:p-6 shadow-[0_20px_50px_rgba(1,0,72,0.3)] border border-cyan-500/40 flex flex-col justify-center overflow-hidden pointer-events-auto">
