...
export default function MainHome({ topProperties }: MainHomeProps) {
  return (
    <>
      ...
      <div className="absolute w-[100%] h-[88vh] top-0 pointer-events-none z-10">
        <div className="pointer-events-auto">
          <Social />
        </div>

        <div className="flex flex-col items-center pt-[85px] text-center md:text-left pointer-events-none">
          <div className="w-[90%] md:w-[75%] mt-[45px] flex flex-col md:flex-row md:justify-between gap-5 overflow-x-auto no-scrollbar pointer-events-none">
            <div className="w-[100%] lg:w-[50%] pointer-events-none">
              <BannerText />
            </div>
              {Array.isArray(topProperties) && topProperties.length > 0 && (
            <div className="w-[100%] lg:w-[40%] pointer-events-auto">
        ...
        <div className="flex justify-center mt-10 pointer-events-none">
          <div className="w-[85%] lg:w-[55%] pointer-events-none">
            <Filter />
          </div>
        </div>
