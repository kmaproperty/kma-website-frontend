...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Privacy Policy | KMA Global Properties",
    description:
      "Learn how KMA Global Properties collects, uses, and protects your personal information under India's DPDP Act 2023.",
    url: "https://kmaglobalproperty.com/privacy-policy",
    locale: "en_IN",
    images: [
      {
        url: "https://kmaglobalproperty.com/assets/images/og/privacy-policy.jpg",
        width: 1200,
        height: 630,
        alt: "Privacy Policy",
      },
  ...
  twitter: {
    ...
    title: "Privacy Policy | KMA Global Properties",
    description:
      "Learn how KMA Global Properties collects, uses, and protects your personal data under India's DPDP Act 2023.",
    images: [
      {
        url: "https://kmaglobalproperty.com/assets/images/og/privacy-policy.jpg",
        alt: "Privacy Policy",
...
export default function PrivacyPolicyPage() {
  const legalPageSchema = {
    ...
    "@type": "WebPage",
    name: "Privacy Policy | KMA Global Properties",
    url: "https://kmaglobalproperty.com/privacy-policy",
    description:
      "Privacy Policy of KMA Global Properties Pvt. Ltd., a Gurugram-based real estate advisory company. This page explains how we collect, use, and protect user data in compliance with the DPDP Act 2023.",
    publisher: {
      "@type": "Organization",
      name: "KMA Global Properties Pvt. Ltd.",
      url: "https://kmaglobalproperty.com",
      logo: "https://kmaglobalproperty.com/assets/kma-logo-white.svg",
      contactPoint: {
        "@type": "ContactPoint",
        telephone: "+91-8047136232",
  ...
  const webPageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://kmaglobalproperty.com/privacy-policy#webpage",
    url: "https://kmaglobalproperty.com/privacy-policy",
    name: "Privacy Policy | KMA Global Properties",
    headline:
      "Privacy Policy | KMA Global Properties – Real Estate Advisory in Gurugram",
    description:
      "Learn how KMA Global Properties Pvt. Ltd. collects, uses and protects your personal information in compliance with the Digital Personal Data Protection Act (DPDP Act), 2023.",
    inLanguage: "en-IN",
    isPartOf: {
    ...
    breadcrumb: {
      "@id": "https://kmaglobalproperty.com/privacy-policy#breadcrumb",
    },
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Privacy Policy",
        item: "https://kmaglobalproperty.com/privacy-policy",
      },
    ],
  };
  ...
  const webPageElementSchema = {
    "@context": "https://schema.org",
    "@type": "WebPageElement",
    "@id": "https://kmaglobalproperty.com/privacy-policy#content",
    name: "Privacy Policy",
    isPartOf: {
      "@id": "https://kmaglobalproperty.com/privacy-policy#webpage",
    },
