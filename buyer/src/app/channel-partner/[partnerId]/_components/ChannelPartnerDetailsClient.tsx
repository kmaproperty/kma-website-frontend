            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                ...
                <a
                  ...
                  className="w-full sm:w-auto px-5 py-2.5 rounded-full bg-[#25D366] text-white font-semibold text-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                >
                  <svg
