...
//             <Link href={hero.featured.webUrl} className="relative overflow-hidden rounded-[24px] border border-cyan-400/30 shadow-[0_20px_60px_rgba(0,212,255,0.08)] group transition-all duration-300 hover:border-cyan-300/60 hover:shadow-[0_0_40px_rgba(103,232,249,0.18)]">
