...
const HelpCenterClient = () => {
  ...
  const postPropertiesAccordionData = [
    {
      ...
      answer:
        "Nothing complicated. You'll need basic property details (location, size, price, ownership status) and a digitally signed MOU. This one-time step is what allows KMA to keep every listing on the platform genuine and traceable, instead of relying on unverified, self-reported ads.",
    },
    {
      question: "How long does it take for a listing to go live?",
      answer:
        "Most listings are reviewed and published within 24 hours of submitting complete information and your signed MOU. Once your listing clears verification, it becomes visible to matching buyers, and any enquiries start flowing straight into your dashboard.",
    },
    {
      question: "How does the verification process actually work?",
      answer:
        "Every submission is checked against the details provided before it's approved. This isn't a rubber-stamp process — it exists specifically to filter out duplicate entries, outdated listings, and spam ads, which is a big part of why buyers trust what they see on KMA in the first place.",
    },
    {
      question: "Can I add photos and videos to my listing?",
      answer:
        "Yes, and we'd recommend it. Listings with clear, high-quality photos consistently attract more genuine enquiries than text-only ads, since buyers want to see the space before they commit to a site visit. You can upload multiple images and videos directly while creating or editing your listing.",
    },
    {
      question: "Can I make changes after my property goes live?",
      answer:
        "Absolutely. Your dashboard (or the Channel Partner Panel, if you're a partner) gives you 24/7 control to edit details, swap out photos, adjust pricing, deactivate the listing temporarily, or remove it entirely — whenever your situation changes.",
    },
  ];
  const propertySearchAccordionData = [
    {
      ...
      answer:
        "Start with the smart filters on the homepage. You can narrow results by location, budget range, or property type to skip past irrelevant ads and get straight to verified, relevant options — no fake listings padding out your search.",
    },
    {
      question: "Do I need an account to browse listings?",
      answer:
        "No — you can browse and search freely without logging in. That said, creating an account unlocks a couple of useful extras: you can save favourite properties for later, and opt in to direct WhatsApp alerts whenever a new listing matches what you're looking for.",
    },
    {
      question: "How do I get in touch with a property owner or builder?",
      answer:
        "Submit an enquiry directly from the property listing page. From there, our team steps in to connect you with the actual owner, builder, or an authorized Channel Partner — so you're never left messaging into a void.",
    },
    {
      question: "Can I schedule a site visit through the platform?",
      answer:
        "Yes. Request a visit right from the listing, and our team will coordinate timing with the owner, builder, or Channel Partner so the visit actually gets arranged, instead of you chasing contact details yourself.",
    },
    {
      question: "Will my enquiry get sent to a dozen different agents?",
      answer:
        "No. This is one of the bigger differences between KMA and typical property portals, we don't broadcast your enquiry to multiple agents hoping someone bites. Instead, KMA connects you directly with the relevant owner, builder, or authorized partner, and backs that up with pre-sales support and CRM-driven lead handling so enquiries don't get lost or spammed out.",
    },
  ];
  const generalQuestionsAccordionData = [
    ...
    },
    {
      ...
      answer:
        "Yes, anytime. Head to your account settings to update your contact information or other profile details whenever they change.",
    },
    {
      question: "Is my personal information kept private?",
      answer:
        "Your data is handled under KMA's Privacy Policy, with security measures in place to protect your account. Your contact details are never displayed publicly on the platform — they're only shared with another party when it's necessary to facilitate a genuine, verified enquiry, such as connecting a buyer with a seller.",
    },
    {
      question: "What should I do if I spot a duplicate or incorrect listing?",
      answer:
        "Reach out to our support team with the listing details. We'll review the report and take appropriate action once it's verified, this keeps the marketplace clean for everyone searching or listing on it.",
    },
  ];
    ...
    <div className="bg-[#f5f5f5]">
        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="flex flex-col gap-8 2md:flex-row 2md:gap-10">
            <div className="space-y-8">
              <SectionHeading
                title=""
                subtitle="Getting Started on KMA"
                type={"left"}
                color=""
                lineTop={true}
                description=""
              />
              <AccordionComponent data={gettingStartedAccordionData} />
            </div>
            <div className="space-y-8">
              <SectionHeading
                title=""
                subtitle="Listing Your Property: The Process"
                type={"left"}
                color=""
                lineTop={true}
                description=""
              />
              <AccordionComponent data={postPropertiesAccordionData} />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-[1440px] min-w-0 sm:mt-12 2md:mt-16">
          <div className="flex flex-col gap-8 2md:flex-row 2md:gap-10">
            <div className="col-auto space-y-8">
              <SectionHeading
                title=""
                subtitle="Searching for Properties as a Buyer"
                type={"left"}
                color=""
                lineTop={true}
                description=""
              />
              <AccordionComponent data={propertySearchAccordionData} />
            </div>
            <div className="col-auto space-y-8">
              <SectionHeading
                title=""
                subtitle="Account, Profile, and Data Privacy"
                type={"left"}
                color=""
                lineTop={true}
                description=""
              />
              <AccordionComponent data={generalQuestionsAccordionData} />
            </div>
          </div>
        </div>
      </div>
      <div className="w-full min-w-0 bg-[#fff] px-4 py-10 md:py-12 lg:py-16 xl:py-20 2xl:py-[100px]">
        <div className="mx-auto w-full max-w-[720px] 2md:w-[50%]">
          ...
          <p className="text-md leading-7 text-center font-normal text-[#0D1520] mb-0">
            Our support team is available Monday to Saturday, 10 AM to 6 PM
          </p>
        </div>
        <div className="flex flex-wrap 2md:gap-3 gap-2 justify-center 2md:mt-8 mt-5">
          ...
          <div className="flex items-center gap-1 text-gray-600 text-[15px]">
            <Image src={"/assets/mail.png"} width={24} height={24} alt="mail" />
            {contactEmail}
          </div>
          <div className="flex items-center gap-1 text-gray-600 text-[15px]">
            <Image
          ...
          <p className="text-center">
            Whether you're posting your first listing or trying to close a deal
            in Gurgaon's competitive market, we're here to help you get it
            right.
          </p>
        </div>
      </div>
