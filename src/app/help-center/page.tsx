...
const HelpCenter = () => {
    ...
    return (
        <div className='bg-[#f5f5f5]'>
            <div className="relative min-h-[min(100dvh,600px)] max-h-[600px] pt-[25px] rounded-br-[40px] rounded-bl-[40px] sm:rounded-br-[72px] sm:rounded-bl-[72px] lg:rounded-br-[100px] lg:rounded-bl-[100px]" style={{ backgroundImage: 'url(assets/app/help-center-herobg.jpg)', backgroundSize: 'cover', backgroundPosition: 'bottom' }}>
                <HomdeHeader />
                <div className="mx-auto mt-24 w-full max-w-[600px] px-4 sm:mt-28 sm:w-[85%] sm:px-0 md:mt-32 md:w-[75%] xl:mt-[150px]">
                    <PageTitle
                        title="Help Center"
