    ...
    <>
      ...
      <div className="w-full min-w-0 px-0 pb-28 pt-6 sm:px-0 sm:pt-8 md:pb-6 md:pt-10">
        ...
        <div className="mx-auto w-full min-w-0">
          <div className="md:rounded-2xl md:border md:border-border md:bg-white md:p-0 md:shadow-sm md:sm:p-5 md:lg:p-8">
        ...
        <div className="hidden md:block fixed inset-x-3 bottom-3 z-20 rounded-full border border-[#D4D5D8] bg-[#F6F6F7] p-3.5 shadow-[0_2px_8px_rgba(16,24,40,0.10),0_6px_20px_rgba(16,24,40,0.12)] xl:hidden">
          <div className="flex items-center justify-between gap-3">
        ...
        <div className="md:hidden block fixed bottom-0 left-0 right-0 z-[99] bg-white rounded-t-[18px] shadow-[0px_-8px_20px_0px_#00000026]">
          <div className="flex justify-between items-center gap-2 py-3 px-2">
            <button
              type="button"
              onClick={() => router.push("/")}
              className={`flex-1 cursor-pointer flex flex-col items-center text-center ${pathname === "/" ? "text-[#010048]" : "text-[#888888]"}`}
            >
              ...
              <p className="block text-xs mt-1.5 leading-none">Home</p>
            </button>

            <button
              type="button"
              onClick={() => router.push("/projects")}
              className={`flex-1 cursor-pointer flex flex-col items-center text-center ${pathname?.startsWith("/projects") ? "text-[#010048]" : "text-[#888888]"}`}
            >
              ...
              <p className="block text-xs mt-1.5 leading-none">Search</p>
            </button>

            <div className="flex-1 text-[#888888] cursor-pointer flex flex-col items-center text-center">
              ...
              <p className="block text-xs mt-1.5 leading-none">Sent/Rent</p>
            </div>

            <button
              type="button"
              onClick={() => router.push("/my-list")}
              className={`flex-1 cursor-pointer flex flex-col items-center text-center ${pathname?.startsWith("/my-list") ? "text-[#010048]" : "text-[#888888]"}`}
            >
              <svg className="w-[24px] h-[24px]" width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="block text-xs mt-1.5 leading-none">Shortlist</p>
            </button>

            <button
              type="button"
              onClick={() => router.push("/profile")}
              className={`flex-1 cursor-pointer flex flex-col items-center text-center ${pathname?.startsWith("/profile") ? "text-[#010048]" : "text-[#888888]"}`}
            >
              <svg className="w-[24px] h-[24px]" width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="block text-xs mt-1.5 leading-none">Profile</p>
            </button>
          </div>
        </div>
      </div>
