...
export default function ProjectsPageClient({
  ...
  return (
    <div className="w-full">
      ...
      <section className="mt-7 w-full rounded-[28px]  px-4  shadow-sm sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <h1 className="mt-3 text-2xl font-semibold text-white sm:text-3xl">
            All Property List
          </h1>
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-end  rounded-2xl p-4 w-[80%]">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-[280px_1fr] rounded-2xl bg-white p-4">
          <aside className="lg:sticky lg:top-6 lg:self-start bg-background-gray p-4 rounded-2xl">
            <FiltersSidebar />
          </aside>

          <main className="min-w-0">
            <div className="rounded-2xl p-4 shadow-sm sm:p-5">
              <div>
