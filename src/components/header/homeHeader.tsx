...
export default function HomdeHeader(){
    return(
        <div className="bg-white/10 rounded-[200px] bg-clip-padding backdrop-filter  backdrop-blur-[20px] h-[63px] px-7 pt-[4px] flex justify-between items-center border border-1 border-[#FFFFFF33]"> 
            ...
            <div className="flex flex-row justify-start items-center gap-4 w-full px-4">
                <div className="flex items-center justify-between cursor-pointer">
                    ...
                    />
                    <p className="pl-1 text-gray-100 text-xs"> City </p>
                ...
                {[
                    ...
                    <p key={item} className="mt-2 text-gray-100 break-word text-xs w-max border-b-2 border-transparent hover:border-blue transition-colors duration-200 cursor-pointer px-1.5  pb-1">
                    {item}
                    </p>
                ))}
