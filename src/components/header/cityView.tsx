  ...
  return (
    <div className="p-2 w-[330px]">
      ...
      <div className="flex flex-wrap gap-1.5 mt-4">
          <div className="flex flex-1 flex-col justify-center items-center gap-1.5 bg-[#F3F3F3] rounded-[5px] px-1 py-3">
          ...
          <div className="flex flex-1 flex-col justify-center items-center gap-1.5 bg-[#F3F3F3] rounded-[5px] px-1 py-3 grayscale hover:grayscale-0 cursor-pointer">
            <Image src={'/assets/city/city1.svg'} width={600} height={600} alt="city" className="w-[45px] h-[34px]"/>
            <p className="text-xs text-black">Hedrabad</p>
          </div>
      </div>
