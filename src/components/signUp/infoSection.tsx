...
export default function InfoSection() {
  return (
    <div className="flex felx-wrap justify-center items-start flex-col sm:mt-[5rem]"  >
      <p className="text-white font-ibm-plex-sans font-semibold text-[1.5rem] sm:text-[1.75rem] lg:text-[2.1rem] mb-2 sm:mb-3">
        Upload Your Property in 3 Easy Steps
      </p>
      <p className="text-text-light-gray font-ibm-plex-sans font-normal text-sm sm:text-base lg:text-lg mb-6 sm:mb-8">
