...
export default function Social() {
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1"><FaInstagram style={{ transform: "rotate(266deg)" }} /> Instagram{"  "}</div>
      <div className="flex items-center gap-1"><FaTwitter style={{ transform: "rotate(266deg)" }} /> Twitter</div>
    </div>
  );
}
