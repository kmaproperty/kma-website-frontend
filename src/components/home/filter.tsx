  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex justify-center gap-2 font-medium text-blue">
        ...
        <button className="w-full md:w-[110px] text-sm 1xl:text-base animated-button-white px-8 py-2 border border-transparent text-center cursor-pointer">
          <span className="gap-3 relative flex justify-center">
            <p className={`text-nowrap`}>Rental</p>
          </span>
        </button>
        <button className="w-full md:w-[110px] text-sm 1xl:text-base animated-button-white px-8 py-2 border border-transparent text-center cursor-pointer">
          <span className="gap-3 relative flex justify-center">
            <p className={`text-nowrap`}>Projects</p>
          </span>
        </button>
        <button className="w-full md:w-[110px] text-sm 1xl:text-base animated-button-white px-8 py-2 border border-transparent text-center cursor-pointer">
          <span className="gap-3 relative flex justify-center">
            <p className={`text-nowrap`}>Plot & Land</p>
          </span>
        </button>
        <button className="w-full md:w-[110px] text-sm 1xl:text-base animated-button-white px-8 py-2 border border-transparent text-center cursor-pointer">
          <span className="gap-3 relative flex justify-center">
            <p className={`text-nowrap`}>Commercial</p>
          </span>
        </button>
      </div>
      ...
      <PriceRangeMenu open={openBudget} onClose={handleBudgetClose} anchorEl={budgetAnchorEl}/>
      <PropertyTypeMenu open={openType} handleClose={handleTypeClose} anchorEl={typeAnchorEl}/>
    </div>
  );
}
