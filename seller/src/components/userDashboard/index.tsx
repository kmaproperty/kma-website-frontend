    ...
    <div className="w-full bg-white rounded-xl">
      <div className="flex flex-col gap-4 p-3">
        ...
        <div className="flex rounded-xl flex-col sm:flex-row gap-3 justify-start items-start sm:items-center bg-[#F2F2F2] p-3">
          ...
          <div>
            <a href={`/api/redirect-to-buyer?path=/help-center`} className="w-full text-sm 1xl:text-base px-5 py-3 border border-[#E7E7E7] text-center cursor-pointer rounded-[5px] bg-light-purple block">
              <span className="gap-3 relative flex justify-center">
